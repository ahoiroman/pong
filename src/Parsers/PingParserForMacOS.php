...
final class PingParserForMacOS extends PingParser implements PingParserInterface
{
    ...
    {
        return ($this->statistics['packets_lost'] < 100) ? 'Ok' : 'Unreachable';
    }
    ...
    {
        if (!str_contains($row, 'round-trip')) {
            return [];
        }
